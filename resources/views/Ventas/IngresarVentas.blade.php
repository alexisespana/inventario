                                ...
                                <div class="invoice-product-details">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12 m3">
                                            <input id="icon_telephone" type="text" name="codigo"
                                                class="validate buscarProducto autocomplete" autofocus>
                                            ...
                                            <tr class="trow hide codigo_prod">
                                                ...
                                                <td class='codigo'>
                                                    <div class="precioPorducto">
                                                        <input class="hide" type="text" id="codigo" name="codigo[]"
                                                            value="" />
                                                    </div>
                                                </td>
                                                ...
                                                <td class="right-align ">
                                                    <a
                                                        class='mb-6 btn-floating waves-effect waves-light red accent-2 list_cancel'>
                                    ...
                                    <div class="row">
                                        <div class="col m4 s12 metodoPago">
                                            ...
                                            <div class="switch">
                                                <label>
                                                    Efectivo
                                                    <input type="checkbox" checked class="switch" name="metodoPago"
                                                        onchange="metodoPago(this)">
                                            ...
                                            <div class="row debito">
                                                <div class="input-field">
                                                    <input id="boleta" type="text" name="nroBoleta"
                                                        class="validate boleta">
                                            ...
                                            <div class="row  efectivo ocultar ">
                                                <li class="display-flex justify-content-between">
                                                    ...
                                                    <h6 class="invoice-subtotal-value">
                                                        <input style="text-align:right" id="cant_efectivo" type="text"
                                                            onkeyup="calcularVuelto(this)" name="cant_efectivo"
                                                            class="validate cant_efectivo">
                                                    </h6>
                                                </li>
                                        ...
                                        <div class="col xl3 m6 s12 offset-xl4">
                                            <ul>
                                                ...
                                                <li class="mt-5">
                                                    <a class="btn disabled btn-block waves-effect waves-light btn pagar "
                                                        href="#editarProductos">Pagar</a>
...
@section('scripts')
    ...
    <script>
        ...
        function suma() {
            ...
            $('.precioTotal, .totalPagar').empty().append(number_format(suma, 2, ',', '.'));
